...
class VolumeAnalysisType(Enum):
    ...
    def analyze(self, data, symbol="EURUSD"):
        """Kelly-compatible analyze method for Volume Strategy"""
        try:
            ...
            if len(data) >= 50:
                ...
                if current_price > ma_20 > ma_50:
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Volume Strategy bullish trend'
                    }
                    ...
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Volume Strategy bearish trend'
                    }
            ...
            return {
                ...
                'confidence': 0.4,
                'price': current_price,
                'reason': f'Volume Strategy neutral'
            }
            ...
            return {
                ...
                'confidence': 0.0,
                'price': 1.0,
                'reason': f'Volume Strategy error: {str(e)}'
            }

...
try:
    ...
    class PrimaryStrategy:
        def analyze(self, data, symbol): return {"signal": "HOLD", "confidence": 0.5, "price": 1.0}, StatefulStrategy, SignalEvent, TradeSetup, register_strategy, StrategyState
...
class ICTPatternType(Enum):
    ...
    def analyze(self, data, symbol="EURUSD"):
        """Kelly-compatible analyze method for Ict Strategy"""
        try:
            ...
            if len(data) >= 50:
                ...
                if current_price > ma_20 > ma_50:
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Ict Strategy bullish trend'
                    }
                    ...
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Ict Strategy bearish trend'
                    }
            ...
            return {
                ...
                'confidence': 0.0,
                'price': 1.0,
                'reason': f'Ict Strategy error: {str(e)}'
            }

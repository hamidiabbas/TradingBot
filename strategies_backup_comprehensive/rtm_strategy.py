...
class RTMZoneType(Enum):
    ...
    def analyze(self, data, symbol="EURUSD"):
        """Kelly-compatible analyze method for Rtm Strategy"""
        try:
            ...
            if len(data) >= 50:
                ...
                if current_price > ma_20 > ma_50:
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Rtm Strategy bullish trend'
                    }
                    ...
                    return {
                        ...
                        'confidence': 0.65,
                        'price': current_price,
                        'reason': f'Rtm Strategy bearish trend'
                    }
            ...
            return {
                ...
                'confidence': 0.0,
                'price': 1.0,
                'reason': f'Rtm Strategy error: {str(e)}'
            }
